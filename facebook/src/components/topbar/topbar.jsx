...
import Rightsectiontopbar from "./rightsectiontopbar/rightsectiontopbar";
  ...
  return (
    <div>
      <div className="topbarAll">
          ...
          <ul>
            ...
            >
              <div className="topbarMenuspacing">
                ...
                <span style={{color:'#dbdada'}}>Home</span>
              </div>
            </Link>
            <Link
              to="/video" 
              className={`${
                isActiveLink("/video") ? "active " : ""
              }responsiveTopbar`}
            >
              <div className="topbarMenuspacing">
                <svg
                ...
                <span style={{color:'#dbdada'}}>Video</span>
            ...
            <Link
              to="/marketplace"
              className={`${
                isActiveLink("/marketplace") ? "active " : ""
              }responsiveTopbar`}
            >
              <div className="topbarMenuspacing">
                <svg
                ...
                <span style={{color:'#dbdada'}}>Marketplace</span>
            ...
            >
              <div className="topbarMenuspacing">
                ...
                <span style={{color:'#dbdada'}}>Groups</span>
            ...
            >
              <div className="topbarMenuspacing ">
                ...
                <span style={{color:'#dbdada'}}>Gaming</span>
        ...
        <div className="topbarBoxShadow"></div>
      </div>
    </div>
  );
}
